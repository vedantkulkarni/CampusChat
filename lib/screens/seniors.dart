...
class Seniors extends StatefulWidget {
  String userFirstName;
  Seniors(this.userFirstName, {Key? key}) : super(key: key);

  @override
  _SeniorsState createState() => _SeniorsState();
}

class _SeniorsState extends State<Seniors> {
  @override
